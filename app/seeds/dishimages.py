...
def seed_d_images():
    italian_one_previmage = DishImage(
    ...
    italian_two_previmage = DishImage(
    ...
    italian_three_previmage = DishImage(
    ...
    italian_four_previmage = DishImage(
    ...
    italian_five_previmage = DishImage(
    ...
    italian_six_previmage = DishImage(
    ...
    mexican_one_previmage = DishImage(
    ...
    mexican_two_previmage = DishImage(
    ...
    mexican_three_previmage = DishImage(
    ...
    mexican_four_previmage = DishImage(
    ...
    mexican_five_previmage = DishImage(
    ...
    mexican_six_previmage = DishImage(
    ...
    mexican_seven_previmage = DishImage(
    ...
    middleast_one_previmage = DishImage(
    ...
    middleast_two_previmage = DishImage(
    ...
    middleast_three_previmage = DishImage(
    ...
    middleast_four_previmage = DishImage(
    ...
    middleast_five_previmage = DishImage(
    ...
    middleast_six_previmage = DishImage(
    ...
    american_one_previmage = DishImage(
    ...
    american_two_previmage = DishImage(
    ...
    american_three_previmage = DishImage(
    ...
    american_four_previmage = DishImage(
    ...
    american_five_previmage = DishImage(
    ...
    american_six_previmage = DishImage(
...
def undo_d_images():
    if environment == "production":
        db.session.execute(f"TRUNCATE table {SCHEMA}.dishimages RESTART IDENTITY CASCADE;")
    else:
        db.session.execute(text("DELETE FROM dishimages"))
    db.session.commit()
